...
Die deutsche Dokumentation beschreibt Installation, Ersteinrichtung, Kameras, Einstellungen, MQTT/UDP, Loxone Config Export, HTTP-Endpunkte, Statuswerte, Dateien, Systemd-Dienst, Binary-Verwaltung, Tests, Entwicklung und Fehlerbehebung.

➡️ **[Zur deutschen Dokumentation](de/README.md)**

## English

The English documentation describes installation, initial setup, cameras, settings, MQTT/UDP, Loxone Config export, HTTP endpoints, status values, files, systemd service, binary handling, tests, development and troubleshooting.

➡️ **[Open English documentation](en/README.md)**
